...
import copy         # serve per la copia profonda, per evitare side effect sulle opinioni binomiali
...
# calcola il miglior hotel raccomandato da casMin e dai vincoli soft per ogni utente
...
# inserimento dei dati in un dizionario in maniera tale da essere processati più semplicemente, era richiesto separare utente da hotel
for key,value in casmin.items():
	k,v=key.split("/$/$/")
